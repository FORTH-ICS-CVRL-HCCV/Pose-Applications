...
while cap.isOpened():
    ...
    cv2.putText(image, "Framerate: %0.2f Hz" % hz, (8,20),  cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 1)
    ...
    distance = np.linalg.norm(right_shoulder - left_shoulder)

    cv2.putText(image, "Euclidean distance between shoulders: %0.2f" %distance, (8,40),  cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 1)
